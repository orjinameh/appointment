...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_t8jnf28', 'template_jra82ms', form.current, 'vD1Q_XJtych9zr3m9')
      .then((result) => {
        setFormData({
          name: '',
          email: '',
  ...
  return (
    <div className='contact-div'>
      <div className="contact-text">
        ...
        <ContactComp text='' 
        title='8855 Balboa Avenue, Suite D, San Diego, CA 92123' 
        ...
        <ContactComp text='' title='1-858-276-7170' svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
